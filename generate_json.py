...
locais = ["[LAB] GAROTAS DO ENIAC", "[LAB] ADA LOVELACE", "[LAB] GRACE HOPPER", "[SALA] HIPACIA DE ALEXANDRIA",
          "[SALA] KAREN SPARK JONES", "[LAB] JEAN SAMMET", "[LAB] RADIA PERLMAN", "[LAB] CAROL SHAW",
          "[SALA] ROBERTA WILLIAMS", "[SALA] FRANCES ALLEN", "TEATRO PYTHONICO", "FREETIME"]
